 ...
 * <p>
 * 对 {@code gregtech:gt.blockmachines}，{@link #matches} / {@link #writeBlockRegistryEntry} 的 {@code meta} 为 GT5U mID（与 {@code registryId@n} 中 {@code n} 一致）。
 * 世界坐标路径见 {@link com.github.wikimultistructure.sde.core.registry.BlockRegistryWorldPolicy}（采样侧 {@link #matches} 不校验 mID 槽，由 {@link #sample} 读 Tile）。
 */
